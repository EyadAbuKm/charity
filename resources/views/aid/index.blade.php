...
<div class="card card-default" style="padding: 2%;">
    ...
    <div class="row">
        ...
        <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalForm" style= "width: 200px;margin-right:2%;" tabindex="2">
            إضافة مساعدة مالية
        </button>

        <button  type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModalForm2" style= "width: 200px;" tabindex="3">
            إضافة مساعدة عينية
        </button>
    ...
    <form action="{{ route('aid.index') }}" method="GET" style="text-align: center; margin-bottom: 20px;" >  
        ...
        <input type="text" name="Family_ID" placeholder="           أدخل رقم الأسرة" required autofocus tabindex="1">  
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{ route('aid.add') }}" method="POST"  style="text-align: right; margin: 0px auto; width:98%" dir="rtl">  
            @csrf  
  <div>
            <input type="hidden" value="{{ $family->Family_ID}}" name="Family_ID" class="form-control" id="Family_ID" required>
            <input type="hidden" value="true" name="redirect_back" class="form-control" id="Family_ID" required>
            ...
            <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
                <div style="width: 48%;">
                    ...
                    <input type="number" id="Family_ID" name="Family_ID" value="{{  $family->Family_ID }}" style="text-align: center;" class="form-control" readonly>
                </div>
                {{-- <div style="width: 48%;">
            ...
            <label for="date">التاريخ</label>  
                        <input type="date" id="date" name="Date_" value="{{ date('Y-m-d') }}" class="form-control">   
            </div>
            ...
            <input type="text" id="comment" name="Comment" placeholder="ملاحظات" class="form-control">  
            </div>
    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="{{ route('aid.add_material') }}" method="POST"  style="text-align: right; margin: 0px auto; width:98%" dir="rtl">  
              @csrf  
    <div>
              <input type="hidden" value="{{ $family->Family_ID}}" name="Family_ID" class="form-control" id="Family_ID" required>
              <input type="hidden" value="true" name="redirect_back" class="form-control" id="Family_ID" required>
